        ...
        jCheckBox1.addItemListener(new ItemListener(){
                ...
                public void itemStateChanged(ItemEvent e) {
                    if(e.getStateChange() == ItemEvent.SELECTED){
                        txtReorderLevel.setEnabled(true);
                    }
                    else if(e.getStateChange() == ItemEvent.DESELECTED){
                        txtReorderLevel.setEnabled(false);
                    }
...
private void Reset()
{
    ...
    private void initComponents() {
        ...
        jCheckBox1.setText("is Imported");
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
     try{
           ...
           if ((txtReorderLevel.getText().equals(""))&& txtReorderLevel.isEnabled() ){
            ...
            boolean p=jCheckBox1.isSelected();
            
            int pro=0;
            int re=0;
            if (p){
                pro=1;
                re=Integer.parseInt(txtReorderLevel.getText());
            }
            String sql= "insert into Products(Product_Id,Product_Name,Product_Type,Reorder_Level,Price,Inventory_level,Total_Sold)values('"+ txtProductID.getText() + "','"+ txtProductName.getText() + "','"+ pro + "','"+ re+ "','" + txtPrice.getText() + "','0','0')";
